...
/**
 * DTO responsável pelos dados de emissão de NFC-e (emitente, destinatário opcional, itens e pagamentos).
 *
...
public class NfceRequest {
    ...
    @NotEmpty(message = "Lista de pagamentos não pode ser vazia")
    @Valid
